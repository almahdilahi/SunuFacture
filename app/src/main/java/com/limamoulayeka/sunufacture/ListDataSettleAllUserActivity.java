...
public class ListDataSettleAllUserActivity extends AppCompatActivity {

    private static final String TAG = "ListDataSettleAllUserActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState){
        ...
        setContentView(R.layout.list_settlealluser_layout);
    ...
    private void populateListView() {
        ...
        Cursor data = mDatabaseHelper.getDataBillUser(bundle.getInt("idUser"));
