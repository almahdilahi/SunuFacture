...
public class ListDataBillActivity extends AppCompatActivity {


    private static final String TAG = "ListDataBillActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState){
        ...
        setContentView(R.layout.list_bill_layout);
        mDatabaseHelper = new Databasehelper(this);
        mListView = findViewById(R.id.listViewBill);
        populateListView();
    }

    private void populateListView() {
        Log.d(TAG, "populateListView: Displaying data in listView.");
        Cursor data = mDatabaseHelper.getDataBill();
