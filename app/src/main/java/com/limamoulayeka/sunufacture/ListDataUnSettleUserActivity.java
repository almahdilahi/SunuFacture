...
public class ListDataUnSettleUserActivity extends AppCompatActivity {



    private static final String TAG = "ListDataUnSettleUserActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState){
        ...
        setContentView(R.layout.list_unsettleuser_layout);
    ...
    private void populateListView() {
        ...
        Cursor data = mDatabaseHelper.getDataBillUnpaidUser(bundle.getInt("idUser"));
